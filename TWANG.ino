...
//              for (int i = 0; i < n0; i ++) {
//                brightness = 255;
//                leds[i] = CRGB(playerPool[0].r, playerPool[0].g, playerPool[0].b);
//                leds[NUM_LEDS-i-1] = CRGB(playerPool[1].r, playerPool[1].g, playerPool[1].b);
//              }
            } else if (stageStartTime+3000 > mm) {
              int n = max(map((mm-stageStartTime), 1500, 3000, 0, NUM_LEDS), 0);
              for (int i = 0; i < n; i ++) {
                brightness = 255;
                leds[getLED(playerPool[0].pos)-i] = CRGB(playerPool[0].r+playerPool[1].r, playerPool[0].g+playerPool[1].g, playerPool[0].b+playerPool[1].b);
                leds[getLED(playerPool[0].pos)+i] = CRGB(playerPool[0].r+playerPool[1].r, playerPool[0].g+playerPool[1].g, playerPool[0].b+playerPool[1].b);
              }
            } else {
              nextLevel();
